...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ numpy numpydoc scipy py2bit pybigwig pysam matplotlib plotly deeptoolsintervals ];

  checkInputs = [
    pytest numpy numpydoc scipy py2bit pybigwig pysam matplotlib plotly deeptoolsintervals
  ];

  meta = with lib; {
    homepage = "https://deeptools.readthedocs.io/en/develop"; 
    description = "Tools for exploring deep sequencing data";
    longDescription = ''
